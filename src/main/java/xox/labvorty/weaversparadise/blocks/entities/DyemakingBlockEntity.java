...
public class DyemakingBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
    ...
    public DyemakingBlockEntity(BlockPos position, BlockState state) {
        super(WeaversParadiseBlockEntities.DYEMAKING_BE.get(), position, state);
    }
    ...
    public AbstractContainerMenu createMenu(int id, Inventory inventory) {
        return new DyemakingMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
    }
