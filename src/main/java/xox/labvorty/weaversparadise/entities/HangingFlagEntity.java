...
public class HangingFlagEntity extends HangingEntity {
    ...
    private HangingFlagEntity(Level level, BlockPos pos) {
        super(WeaversParadiseEntityTypes.HANGING_FLAG_ENTITY, level, pos);
    }
    ...
    public ItemStack getPickResult() {
        String variant = getVariant();
        if (variant.equals("agender")) {
            return new ItemStack(WeaversParadiseItems.FLAG_AGENDER);
        } else if (variant.equals("aroace")) {
            return new ItemStack(WeaversParadiseItems.FLAG_AROACE);
        } else if (variant.equals("aromantic")) {
            return new ItemStack(WeaversParadiseItems.FLAG_AROMANTIC);
        } else if (variant.equals("asexual")) {
            return new ItemStack(WeaversParadiseItems.FLAG_ASEXUAL);
        } else if (variant.equals("bisexual")) {
            return new ItemStack(WeaversParadiseItems.FLAG_BISEXUAL);
        } else if (variant.equals("demiboy")) {
            return new ItemStack(WeaversParadiseItems.FLAG_DEMIBOY);
        } else if (variant.equals("demigender")) {
            return new ItemStack(WeaversParadiseItems.FLAG_DEMIGENDER);
        } else if (variant.equals("demigirl")) {
            return new ItemStack(WeaversParadiseItems.FLAG_DEMIGIRL);
        } else if (variant.equals("gay")) {
            return new ItemStack(WeaversParadiseItems.FLAG_GAY);
        } else if (variant.equals("genderfluid")) {
            return new ItemStack(WeaversParadiseItems.FLAG_GENDERFLUID);
        } else if (variant.equals("genderqueer")) {
            return new ItemStack(WeaversParadiseItems.FLAG_GENDERQUEER);
        } else if (variant.equals("intersex")) {
            return new ItemStack(WeaversParadiseItems.FLAG_INTERSEX);
        } else if (variant.equals("lesbian")) {
            return new ItemStack(WeaversParadiseItems.FLAG_LESBIAN);
        } else if (variant.equals("nonbinary")) {
            return new ItemStack(WeaversParadiseItems.FLAG_NONBINARY);
        } else if (variant.equals("pansexual")) {
            return new ItemStack(WeaversParadiseItems.FLAG_PANSEXUAL);
        } else if (variant.equals("pride")) {
            return new ItemStack(WeaversParadiseItems.FLAG_PRIDE);
        } else if (variant.equals("trans")) {
            return new ItemStack(WeaversParadiseItems.FLAG_TRANS);
        } else {
            return new ItemStack(WeaversParadiseItems.FLAG_BASIC);
        }
    }
