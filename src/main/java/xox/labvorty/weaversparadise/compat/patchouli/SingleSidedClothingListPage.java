...
public class SingleSidedClothingListPage extends PageWithText {
    ...
    private void spawnEntityWithVariant(Level world, int index) {
        ...
        try {
            ...
            if (entityNbt.contains("Item")) {
                ...
                CompoundTag components = itemTag.contains("components") ? itemTag.getCompound("components") : new CompoundTag();
    ...
    private static CompoundTag makeCustomData(String dyeType, int r, int g, int b) {
        ...
        tag.putString("dyeTypeOne", dyeType);
        tag.putString("dyeTypeTwo", dyeType);
        tag.putString("stensilType", "default");
        tag.putInt("colorPriRedOne", r);
        tag.putInt("colorPriGreenOne", g);
        tag.putInt("colorPriBlueOne", b);
        tag.putInt("colorPriRedTwo", r);
        tag.putInt("colorPriGreenTwo", g);
        tag.putInt("colorPriBlueTwo", b);
        tag.putInt("colorSecRedOne", r);
        tag.putInt("colorSecGreenOne", g);
        tag.putInt("colorSecBlueOne", b);
        tag.putInt("colorSecRedTwo", r);
        tag.putInt("colorSecGreenTwo", g);
        tag.putInt("colorSecBlueTwo", b);
        tag.putInt("lightValueOne", 15);
        tag.putInt("lightValueTwo", 15);
