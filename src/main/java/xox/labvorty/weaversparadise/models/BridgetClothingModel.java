...
public class BridgetClothingModel<T extends Entity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("weaversparadise", "bridget_clothing_model"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float r, float g, float b, float a) {
		...
		RightLegPants.render(poseStack, vertexConsumer, packedLight, packedOverlay, r, g, b, a);
		LeftLeg.render(poseStack, vertexConsumer, packedLight, packedOverlay, r, g, b, a);
		LeftLegPants.render(poseStack, vertexConsumer, packedLight, packedOverlay, r, g, b, a);
