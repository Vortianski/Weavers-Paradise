...
public class ThighHighsWoolItem extends DoubleSidedClothingArmorItem implements ThighHighsInterface {
    public ThighHighsWoolItem() {
        super(
                new Item.Properties()
                        .stacksTo(1)
    ...
    protected List<ResourceKey<Enchantment>> getSupportedEnchantments() {
        return List.of(
                ...
                WeaversParadiseEnchantments.SOUND_MUFFLER
        );
    }
}
