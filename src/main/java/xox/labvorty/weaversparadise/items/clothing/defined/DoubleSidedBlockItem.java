...
public abstract class DoubleSidedBlockItem extends BlockItem implements AdvancedItemOptions {
    public DoubleSidedBlockItem(Block block, Properties properties) {
    ...
    public @NotNull Optional<TooltipComponent> getTooltipImage(ItemStack stack) {
        ...
        return Optional.of(
                new ClothingTooltipComponent(
                        QualityTooltipData.getTooltipData(10),
                        entries
                )
        );
    }
