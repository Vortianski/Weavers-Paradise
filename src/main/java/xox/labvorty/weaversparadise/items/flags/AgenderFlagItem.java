...
public class AgenderFlagItem extends HangingEntityItem {
    public AgenderFlagItem() {
        super(
                null,
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (player != null && !this.mayPlace(player, direction, itemstack, blockpos1)) {
            ...
            if (true) {
                Optional<HangingFlagEntity> hangingFlagEntity = HangingFlagEntity.create(level, blockpos1, direction, "agender");
