...
public class LesbianFlagItem extends HangingEntityItem {
    public LesbianFlagItem() {
        super(
                null,
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (player != null && !this.mayPlace(player, direction, itemstack, blockpos1)) {
            ...
            if (true) {
                Optional<HangingFlagEntity> hangingFlagEntity = HangingFlagEntity.create(level, blockpos1, direction, "lesbian");
