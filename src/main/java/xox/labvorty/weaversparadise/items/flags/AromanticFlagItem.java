...
public class AromanticFlagItem extends HangingEntityItem {
    public AromanticFlagItem() {
        super(
                null,
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (player != null && !this.mayPlace(player, direction, itemstack, blockpos1)) {
            ...
            if (true) {
                Optional<HangingFlagEntity> hangingFlagEntity = HangingFlagEntity.create(level, blockpos1, direction, "aromantic");
