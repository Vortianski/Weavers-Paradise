...
public class ArmorLootboxItem extends Item {
    public List<Item> items = List.of(
            WeaversParadiseItems.ASTOLFO_COSMETICS.get(),
            WeaversParadiseItems.BRIDGET_COSMETICS.get(),
            WeaversParadiseItems.FELIX_COSMETICS.get(),
            WeaversParadiseItems.GRIFFITH_COSMETICS.get(),
            WeaversParadiseItems.NIKO_COSMETICS.get(),
            WeaversParadiseItems.GABRIEL_COSMETICS.get(),
            WeaversParadiseItems.GISELLE_COSMETICS.get(),
            WeaversParadiseItems.MIKKELA_COSMETICS.get(),
            WeaversParadiseItems.EXPIE_COSMETICS.get(),
            WeaversParadiseItems.GASTER_COSMETICS.get(),
            WeaversParadiseItems.RALSEI_COSMETICS.get(),
            WeaversParadiseItems.MINOS_PRIME_COSMETICS.get(),
            WeaversParadiseItems.JAYA_UTOMO_COSMETICS.get()
    );
