...
public abstract class AstolfoArmorItem extends ArmorItem {
    public AstolfoArmorItem(Type type, Properties properties) {
        super(
                new ArmorMaterial() {
                    @Override
                    ...
                    public String getName() {
                        return "weaversparadise:astolfo_armor";
                    }
    ...
    public static class Helmet extends AstolfoArmorItem {
        public Helmet() {
    ...
    public static class Chestplate extends AstolfoArmorItem {
        public Chestplate() {
    ...
    public static class Leggings extends AstolfoArmorItem {
        public Leggings() {
    ...
    public static class Boots extends AstolfoArmorItem {
        public Boots() {
