...
public class ShirtOpenTextures {
    private static final String CLOTHING_TYPE = "shirt_open";
    ...
    private static void registerDefaultVariants() {
        registerTexture(STENCIL_DEFAULT, MATERIAL_COTTON, "shirt_base_open.png", "shirt_base_open.png", false);
        registerTexture(STENCIL_DEFAULT, MATERIAL_WOOL, "sweater.png", "sweater.png", false);
        registerTexture(STENCIL_DEFAULT, MATERIAL_SILK, "shirt_silk_open.png", "shirt_silk_open.png", false);
    }

    private static void registerPatternVariants() {
        registerPattern(STENCIL_HALF, "open/shirt_base_half_1.png", "open/shirt_base_half_2.png", "sweater_half_1.png", "sweater_half_2.png", "open/shirt_silk_half_1.png", "open/shirt_silk_half_2.png");
        registerPattern(STENCIL_CHECKERS, "open/shirt_base_checkers_1.png", "open/shirt_base_checkers_2.png", "sweater_checkers_1.png", "sweater_checkers_2.png", "open/shirt_silk_checkers_1.png", "open/shirt_silk_checkers_2.png");
        registerPattern(STENCIL_VERTICAL_LINES, "open/shirt_base_vertical_lines_1.png", "open/shirt_base_vertical_lines_2.png", "sweater_vertical_lines_1.png", "sweater_vertical_lines_2.png", "open/shirt_silk_vertical_lines_1.png", "open/shirt_silk_vertical_lines_2.png");
        registerPattern(STENCIL_SMALL_LINES, "open/shirt_base_small_lines_1.png", "open/shirt_base_small_lines_2.png", "sweater_small_lines_1.png", "sweater_small_lines_2.png", "open/shirt_silk_small_lines_1.png", "open/shirt_silk_small_lines_2.png");
        registerPattern(STENCIL_BIG_LINES, "open/shirt_base_big_lines_1.png", "open/shirt_base_big_lines_2.png", "sweater_big_lines_1.png", "sweater_big_lines_2.png", "open/shirt_silk_big_lines_1.png", "open/shirt_silk_big_lines_2.png");
        registerPattern(STENCIL_CHECKERS_SMALL, "open/shirt_base_checkers_small_1.png", "open/shirt_base_checkers_small_2.png", "sweater_checkers_small_1.png", "sweater_checkers_small_2.png", "open/shirt_silk_checkers_small_1.png", "open/shirt_silk_checkers_small_2.png");
    }
