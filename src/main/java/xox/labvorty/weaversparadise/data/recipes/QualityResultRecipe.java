...
import xox.labvorty.weaversparadise.mixins.ShapedRecipeAccessor;
         ...
         private final MapCodec<QualityResultRecipe> CODEC = RecordCodecBuilder.mapCodec((instance) ->
                 instance.group(
                         ShapedRecipe.Serializer.CODEC.forGetter(recipe -> new ShapedRecipe(
                                 recipe.getGroup(),
                                 recipe.category(),
                                 ((ShapedRecipeAccessor) recipe).weaversparadise$getPattern(),
                                 recipe.result,
                         ...
                         ((ShapedRecipeAccessor) shapedRecipe).weaversparadise$getPattern(),
