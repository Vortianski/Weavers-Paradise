...
public class DyeCoreUpgradeRecipe extends ShapelessRecipe {
    public DyeCoreUpgradeRecipe(
            String group,
    ...
    public static class Serializer implements RecipeSerializer<DyeCoreUpgradeRecipe> {
        public static Serializer INSTANCE = new Serializer();

        private final StreamCodec<RegistryFriendlyByteBuf, DyeCoreUpgradeRecipe> STREAM_CODEC = StreamCodec.of(this::toNetwork, this::fromNetwork);

        @Override
        public @NotNull MapCodec<DyeCoreUpgradeRecipe> codec() {
            return RecipeSerializer.SHAPELESS_RECIPE.codec().xmap(
                    recipe -> {
                        return new DyeCoreUpgradeRecipe(
                                recipe.getGroup(),
                                recipe.category(),
        ...
        @Override
        public @NotNull StreamCodec<RegistryFriendlyByteBuf, DyeCoreUpgradeRecipe> streamCodec() {
            return STREAM_CODEC;
        }

        private DyeCoreUpgradeRecipe fromNetwork(RegistryFriendlyByteBuf buffer) {
        ...
        public void toNetwork(RegistryFriendlyByteBuf buffer, DyeCoreUpgradeRecipe recipe) {
