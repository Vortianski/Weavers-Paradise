...
public class DyeCoreUpgradeRecipe extends ShapelessRecipe {
    public DyeCoreUpgradeRecipe(ResourceLocation id, String group, ItemStack result, NonNullList<Ingredient> ingredients) {
    ...
    public static class Serializer implements RecipeSerializer<DyeCoreUpgradeRecipe> {
        ...
        @Override
        public DyeCoreUpgradeRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new DyeCoreUpgradeRecipe(id, group, result, ingredients);
        }

        @Override
        public DyeCoreUpgradeRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, DyeCoreUpgradeRecipe recipe) {
