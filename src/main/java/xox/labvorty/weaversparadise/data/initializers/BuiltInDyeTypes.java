...
import xox.labvorty.weaversparadise.data.text.ComponentFormatter;
...
public class BuiltInDyeTypes {
    ...
    public static void register() {
        DyeTypeRegistry.registerDyeType(
                "rainbow",
                new ItemDyeIcon(WeaversParadiseItems.CHROMATIC_BLOOM_FRUIT),
        ...
        DyeTypeRegistry.registerDyeType(
                ...
                (dyeData) -> {
                    return dyeData.getComponent().copy().withColor(0x2e2e2e);
                },
                (dyeDataColor) -> {
                    if (dyeDataColor.layer() == 1) {
                        return 255 << 24;
                ...
                (renderData) -> {
                    return WPRenderTypes.getEntityEndPortal(
        ...
        DyeTypeRegistry.registerDyeType(
                ...
                (dyeData) -> {
                    ...
                    for (int i = 0; i < length; i++) {
                        ...
                        MutableComponent letter = Component.literal(String.valueOf(c)).withColor(finalColor);
                        mutableComponent.append(letter);
                    }
        ...
        DyeTypeRegistry.registerDyeType(
                ...
                (dyeData) -> {
                    ...
                    for (int i = 0; i < val.length(); i++) {
                        ...
                        mutableComponent.append(Component.literal(String.valueOf(c)).withColor(color));
                    }
        ...
        DyeTypeRegistry.registerDyeType(
                ...
                (dyeData) -> {
                    ...
                    return dyeData.getComponent().copy().withColor(255 << 24 | color << 16);
                },
                (dyeDataColor) -> {
                    if (dyeDataColor.layer() == 1) {
        ...
        DyeTypeRegistry.registerDyeType(
                ...
                (dyeData) -> {
                    ...
                    return dyeData.getComponent().copy().withColor(finalColor);
                },
                (dyeDataColor) -> {
                    if (dyeDataColor.layer() == 1) {
        ...
        DyeTypeRegistry.registerDyeType(
                "pride",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_PRIDE),
                ...
                (renderData) -> {
                    ...
                    return WPRenderTypes.getEntityTranslucentMask(
                            renderData.resourceLocation(),
                            mask
                    );
                }
        ...
        DyeTypeRegistry.registerDyeType(
                "asexual",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_ASEXUAL),
        ...
        DyeTypeRegistry.registerDyeType(
                "aromantic",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_AROMANTIC),
        ...
        DyeTypeRegistry.registerDyeType(
                "aroace",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_AROACE),
        ...
        DyeTypeRegistry.registerDyeType(
                "agender",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_AGENDER),
        ...
        DyeTypeRegistry.registerDyeType(
                "bisexual",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_BISEXUAL),
        ...
        DyeTypeRegistry.registerDyeType(
                "demiboy",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_DEMIBOY),
        ...
        DyeTypeRegistry.registerDyeType(
                "demigender",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_DEMIGENDER),
        ...
        DyeTypeRegistry.registerDyeType(
                "demigirl",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_DEMIGIRL),
        ...
        DyeTypeRegistry.registerDyeType(
                "gay",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_GAY),
        ...
        DyeTypeRegistry.registerDyeType(
                "genderfluid",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_GENDERFLUID),
        ...
        DyeTypeRegistry.registerDyeType(
                "genderqueer",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_GENDERQUEER),
        ...
        DyeTypeRegistry.registerDyeType(
                "intersex",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_INTERSEX),
        ...
        DyeTypeRegistry.registerDyeType(
                "lesbian",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_LESBIAN),
        ...
        DyeTypeRegistry.registerDyeType(
                "nonbinary",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_NONBINARY),
        ...
        DyeTypeRegistry.registerDyeType(
                "pansexual",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_PANSEXUAL),
        ...
        DyeTypeRegistry.registerDyeType(
                "trans",
                new ItemDyeIcon(WeaversParadiseItems.FLAG_TRANS),
        ...
        DyeTypeRegistry.registerDyeType(
                "polychromatic",
                new ItemDyeIcon(WeaversParadiseItems.CHROMATIC_DUST),
                ...
                (renderData) -> {
                    return WPRenderTypes.getEntityPolychromatic(
                            renderData.resourceLocation()
                    );
                }
        );
        ...
        DyeTypeRegistry.registerDyeType(
                ...
                (dyeDataColor) -> -1,
                (renderData) -> {
                    return WPRenderTypes.getEntityStaticNoise(
                            renderData.resourceLocation()
                    );
                }
        );
        ...
        DyeTypeRegistry.registerDyeType(
                ...
                (dyeData) -> {
                    return dyeData.getComponent().copy().withColor(dyeData.getColorOne());
                },
                (dyeDataColor) -> {
                    if (dyeDataColor.layer() == 1) {
                        return dyeDataColor.colorOne();
                ...
                (renderData) -> {
                    return WPRenderTypes.getEntityCrystal(
                            renderData.resourceLocation()
                    );
                }
        );
        ...
        DyeTypeRegistry.registerDyeType(
                "negative",
                new ItemDyeIcon(WeaversParadiseItems.WITCHROOT_FRUIT),
                ...
                (renderData) -> {
                    return WPRenderTypes.getEntityNegative(
                            renderData.resourceLocation()
                    );
                }
        );
        ...
        DyeTypeRegistry.registerDyeType(
                "true_negative",
                new ItemDyeIcon(WeaversParadiseItems.WITCHROOT_FRUIT_COOKED),
                ...
                (renderData) -> {
                    return WPRenderTypes.getEntityTrueNegative(
                            renderData.resourceLocation()
                    );
                }
        );
        ...
        DyeTypeRegistry.registerDyeType(
                ...
                (renderData) -> {
                    return WPRenderTypes.getEntityNebula(
                            renderData.resourceLocation()
                    );
                }
        );
        ...
        DyeTypeRegistry.registerDyeType(
                "hunger",
                new DyeIcon(ResourceLocation.fromNamespaceAndPath("minecraft", "textures/gui/sprites/hud/food_full.png")),
                ...
                (dyeData) -> {
                    ...
                    return dyeData.getComponent().copy().withColor(colorRed << 16 | colorGreen << 8 | colorBlue);
                },
                (dyeDataColor) -> {
                    if (dyeDataColor.layer() == 1) {
                        Minecraft minecraft = Minecraft.getInstance();
        ...
        DyeTypeRegistry.registerDyeType(
                "health",
                new DyeIcon(ResourceLocation.fromNamespaceAndPath("minecraft", "textures/gui/sprites/hud/heart/full.png")),
        ...
        DyeTypeRegistry.registerDyeType(
                "starfall",
                new ItemDyeIcon(WeaversParadiseItems.STARBLOOM_FRUIT),
                ...
                (renderData) -> {
                    return WPRenderTypes.getEntityParallax(
                            renderData.resourceLocation(),
                            TheEndPortalRenderer.END_PORTAL_LOCATION,
                            new Pair<>(0f, 10f),
                            0.7854f,
        ...
        DyeTypeRegistry.registerDyeType(
                ...
                new ItemDyeIcon(Items.RED_STAINED_GLASS),
                Component.translatable("weaversparadise.dye_text.chromatic_aberration"),
                (dyeData) -> {
                    return dyeData.getComponent().copy();
                },
                (dyeDataColor) -> {
                    return -1;
                },
                (renderData) -> {
                    return WPRenderTypes.getEntityChromaticAberration(
                            renderData.resourceLocation()
                    );
                }
        );
        ...
        DyeTypeRegistry.registerDyeType(
                "boykisser",
                new ItemDyeIcon(WeaversParadiseItems.CAT_RING),
                Component.translatable("weaversparadise.dye_text.boykisser"),
                (dyeData) -> {
                    return dyeData.getComponent().copy();
                },
                (dyeDataColor) -> {
                ...
                (renderData) -> {
                    return WPRenderTypes.getEntityParallax(
                            ...
                            ResourceLocation.fromNamespaceAndPath(
                                    "weaversparadise",
                                    "textures/clothing/mask/boykisser.png"
                            ),
                            new Pair<>(100f, 100f),
                            3.14159f,
                            0,
        ...
        DyeTypeRegistry.registerDyeType(
                ...
                Component.translatable("weaversparadise.dye_text.forcefield"),
                (dyeData) -> {
                    return dyeData.getComponent().copy();
                },
                (dyeDataColor) -> {
        ...
        DyeTypeRegistry.registerDyeType(
                "hypnotic",
                new ItemDyeIcon(Items.BARRIER),
                Component.translatable("weaversparadise.dye_text.hypnotic"),
                (dyeData) -> {
                    return dyeData.getComponent().copy();
                },
                (dyeDataColor) -> {
                ...
                (renderData) -> {
                    return WPRenderTypes.getEntitySpiral(
                            renderData.resourceLocation()
                    );
                }
        );
