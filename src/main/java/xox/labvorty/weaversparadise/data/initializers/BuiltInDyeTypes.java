...
public class BuiltInDyeTypes {
    ...
    public static void register() {
        ...
        DyeTypeRegistry.registerDyeType(
                "negative",
                new ItemDyeIcon(WeaversParadiseItems.WITCHROOT_FRUIT.get()),
        ...
        DyeTypeRegistry.registerDyeType(
                "true_negative",
                new ItemDyeIcon(WeaversParadiseItems.WITCHROOT_FRUIT_COOKED.get()),
        ...
        DyeTypeRegistry.registerDyeType(
                "starfall",
                new ItemDyeIcon(WeaversParadiseItems.STARBLOOM_FRUIT.get()),
                ...
                (renderData) -> {
                    return VortyLibRenderTypes.getEntityParallax(
                            renderData.resourceLocation(),
                            TheEndPortalRenderer.END_PORTAL_LOCATION,
                            new Pair<>(0f, 10f),
                            0.7854f,
        ...
        DyeTypeRegistry.registerDyeType(
                ...
                (renderData) -> {
                    return VortyLibRenderTypes.getEntityChromaticAberration(
                            renderData.resourceLocation()
                    );
                }
        );
        ...
        DyeTypeRegistry.registerDyeType(
                "boykisser",
                new ItemDyeIcon(WeaversParadiseItems.CAT_RING.get()),
        ...
        DyeTypeRegistry.registerDyeType(
                ...
                (renderData) -> {
                    return VortyLibRenderTypes.getEntitySpiral(
                            renderData.resourceLocation()
                    );
                }
        );
