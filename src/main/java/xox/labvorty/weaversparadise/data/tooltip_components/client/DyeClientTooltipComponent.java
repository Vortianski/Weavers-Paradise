...
public class DyeClientTooltipComponent implements ClientTooltipComponent {
    ...
    public int getWidth(Font font) {
        int v1 = !isCore ?
                ...
                poweredCores.contains(type) ?
                        font.width(Component.literal("Power:").append(WPUtilities.createHoldBar(lightValue, 15)))
                        : 0;
    ...
    public void renderImage(@NotNull Font font, int x, int y, @NotNull GuiGraphics guiGraphics) {
        ...
        if (!isCore) {
            ItemStack primaryPigment = new ItemStack(WeaversParadiseItems.PURE_DYE);
            ...
            ItemStack secondaryPigment = new ItemStack(WeaversParadiseItems.PURE_DYE);
            ...
            if (poweredCores.contains(type)) {
                guiGraphics.drawString(font, Component.literal("Power:").append(WPUtilities.createHoldBar(lightValue, 15)), x, y + 10, 0xFFFFFF);
            }
        }
