...
public enum DyeHandler {
    ...
    private static final Map<Item, DyeHandler> HANDLER_MAP =
            Stream.of(values()).collect(Collectors.toMap(DyeHandler::getInstance, e -> e));

    DyeHandler(String name, Item instance, int red, int green, int blue) {
        this.name = name;
        this.red = red;
        this.green = green;
        this.blue = blue;
    ...
    public static DyeHandler getOrDefault(Item item) {
