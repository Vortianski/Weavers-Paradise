...
public class DyeTooltipData {
    ...
    public static MutableComponent parse(String s, String type, int ticks, int primaryColor, int secondaryColor, int lightValue) {
        ...
        if (type.equals("default") || type.equals("crystal") || type.equals("invisible")) {
            component = dyeText.copy().withColor(primaryColor);
        } else if (type.equals("ender")) {
            component = dyeText.copy().withColor(0x2e2e2e);
            ...
            component = dyeText.copy().withColor(color);
            ...
            component = dyeText.copy().withColor(colorRed << 16 | colorGreen << 8 | colorBlue);
            ...
            for (int i = 0; i < val.length(); i++) {
                ...
                component.append(Component.literal(String.valueOf(c)).withColor(color));
            }
            ...
            component = dyeText.copy().withColor(255 << 24 | color << 16 | 0 << 8 | 0);
            ...
            component = dyeText.copy().withColor(finalColor);
