...
public class MikkelaModel<T extends Entity> extends EntityModel<T> {
    ...
    public final ModelPart BodyGlow;
	public final ModelPart Head;
	public final ModelPart RightLeg;
	public final ModelPart LeftLeg;

	public MikkelaModel(ModelPart root) {
		this.LeftArm = root.getChild("LeftArm");
		this.RightArm = root.getChild("RightArm");
		this.Body = root.getChild("Body");
        this.BodyGlow = root.getChild("BodyGlow");
	...
	public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition BodyGlow = partdefinition.addOrReplaceChild("BodyGlow", CubeListBuilder.create().texOffs(72, 26).mirror().addBox(-3.7126F, -1.1976F, -2.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.001F)).mirror(false), PartPose.offsetAndRotation(3.6365F, 5.2239F, -3.4391F, -0.6429F, -0.1321F, -0.2614F));

		PartDefinition LeftArm_r1 = BodyGlow.addOrReplaceChild("LeftArm_r1", CubeListBuilder.create().texOffs(72, 26).mirror().addBox(-3.7126F, -1.1976F, -2.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.001F)).mirror(false), PartPose.offsetAndRotation(3.6365F, 5.2239F, -3.4391F, -0.6429F, -0.1321F, -0.2614F));

		PartDefinition Left_Arm_r2 = BodyGlow.addOrReplaceChild("Left_Arm_r2", CubeListBuilder.create().texOffs(72, 16).mirror().addBox(-1.4084F, -4.3283F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0001F)).mirror(false), PartPose.offsetAndRotation(3.6365F, 5.2239F, -3.4391F, -0.6247F, 0.2097F, 0.1938F));

		PartDefinition Right_Arm_r5 = BodyGlow.addOrReplaceChild("Right_Arm_r5", CubeListBuilder.create().texOffs(72, 26).addBox(-1.2874F, -1.1976F, -2.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.001F)), PartPose.offsetAndRotation(-3.6365F, 5.2239F, -3.4391F, -0.6429F, 0.1321F, 0.2614F));

		PartDefinition Right_Arm_r6 = BodyGlow.addOrReplaceChild("Right_Arm_r6", CubeListBuilder.create().texOffs(72, 16).addBox(-2.5916F, -4.3283F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0001F)), PartPose.offsetAndRotation(-3.6365F, 5.2239F, -3.4391F, -0.6247F, -0.2097F, -0.1938F));
