...
public class FelixModel<T extends Entity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("weaversparadise", "felix_clothing_model"), "main");
	...
	public FelixModel(ModelPart root) {
	...
	public void renderToBuffer(@NotNull PoseStack poseStack, @NotNull VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		...
		Right_Leg2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Left_Leg.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Left_Leg2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
}