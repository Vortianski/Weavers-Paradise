...
public class GabrielModel<T extends Entity> extends EntityModel<T> {
    ...
    public final ModelPart HeadGlow;
    public final ModelPart RightLeg;
    public final ModelPart LeftLeg;
    public final ModelPart LeftBoot;
    public final ModelPart RightBoot;

	public GabrielModel(ModelPart root) {
		this.LeftArm = root.getChild("LeftArm");
		this.RightArm = root.getChild("RightArm");
		this.Body = root.getChild("Body");
        this.BodyGlow = root.getChild("BodyGlow");
		this.Head = root.getChild("Head");
        this.HeadGlow = root.getChild("HeadGlow");
	...
	public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(32, 71).addBox(-1.0F, -1.8F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.251F))
                .texOffs(48, 71).addBox(-1.0F, -1.8F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.45F)), PartPose.offset(5.0F, 2.0F, 0.0F));

        PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(48, 55).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.251F))
                .texOffs(0, 61).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.45F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
        ...
        PartDefinition BodyGlow = partdefinition.addOrReplaceChild("BodyGlow", CubeListBuilder.create().texOffs(0, 0).addBox(-23.5F, -13.0F, 7.0F, 47.0F, 23.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition HeadGlowPivot = partdefinition.addOrReplaceChild("HeadGlow", CubeListBuilder.create(), PartPose.offset(0.0F, -1.0F, 0.0F));

        PartDefinition HeadGlow = HeadGlowPivot.addOrReplaceChild("HeadGlowPart", CubeListBuilder.create().texOffs(0, 23).mirror().addBox(-11.0F, -11.0F, 0.0F, 22.0F, 22.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, -9.0F, 5.0F, 0.0F, 0.0F, -0.7854F));
