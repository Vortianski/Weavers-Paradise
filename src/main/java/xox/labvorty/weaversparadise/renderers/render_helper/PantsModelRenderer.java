...
import xox.labvorty.weaversparadise.data.WeaversParadisePantsTextureHandler;
...
public class PantsModelRenderer {
    ...
    public void renderModel(
        ...
        String renderType = WeaversParadisePantsTextureHandler.getByTypeAndMaterial(sT, mat).getRenderType();
        ResourceLocation tex1 = WeaversParadisePantsTextureHandler.getByTypeAndMaterial(sT, mat).getTextureOne();
        ResourceLocation tex2 = WeaversParadisePantsTextureHandler.getByTypeAndMaterial(sT, mat).getTextureTwo();
