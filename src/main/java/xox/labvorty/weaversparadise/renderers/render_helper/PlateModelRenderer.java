...
import xox.labvorty.weaversparadise.data.WeaversParadisePlateTextureHandler;
...
public class PlateModelRenderer {
    ...
    public void renderModel(
        ...
        WeaversParadisePlateTextureHandler handler = WeaversParadisePlateTextureHandler.getByMetalType(metalType);
        int finalColor;
