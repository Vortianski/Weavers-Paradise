...
public class CapeRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    public void renderByItem(
        ...
        ((PlayerModelInterface)playerModel).getCloak().render(poseStack, vertexConsumer1, finalLightOne, packedOverlay, finalColorOne);
        ...
        if (capeTextures.getRenderType().equals("double")) {
            ...
            ((PlayerModelInterface)playerModel).getCloak().render(poseStack, vertexConsumer2, finalLightTwo, packedOverlay, finalColorTwo);
        }
