...
public class FishRenderer extends BlockEntityWithoutLevelRenderer {
    private final FishModel<?> fishModel;

    public FishRenderer(BlockEntityRenderDispatcher dispatcher, EntityModelSet entityModels) {
        super(dispatcher, entityModels);
        this.fishModel = new FishModel<>(entityModels.bakeLayer(FishModel.LAYER_LOCATION));
    }
    ...
    public void renderByItem(
        ...
        if (!(stack.getItem() instanceof FishItem fishItem)) return;
