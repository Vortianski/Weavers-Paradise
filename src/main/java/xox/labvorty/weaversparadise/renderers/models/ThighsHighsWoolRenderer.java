...
public class ThighsHighsWoolRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("weaversparadise", "textures/clothing/thigh_highs_warm.png");
    ...
    public ThighsHighsWoolRenderer() {
        ...
        this.model1 = new ThighHighsModel(Minecraft.getInstance().getEntityModels().bakeLayer(WeaversParadiseMobLayers.THIGH_HIGHS));
    }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
        ...
        if (stack.getItem() instanceof ThighHighsWool thighHighsWool) {
            ...
            String renderTypeLeft = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "wool").getRenderType();
            ResourceLocation tex1left = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "wool").getTextureOne();
            ResourceLocation tex2left = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "wool").getTextureTwo();

            String renderTypeRight = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeRight, "wool").getRenderType();
            ResourceLocation tex1right = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeRight, "wool").getTextureOne();
            ResourceLocation tex2right = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeRight, "wool").getTextureTwo();
            ...
            if (playerModel instanceof HumanoidModel<?>) {
                ...
                this.model1.RightLeg.copyFrom(humModel.rightLeg);
                this.model1.LeftLeg.copyFrom(humModel.leftLeg);
            }
            ...
            this.model.LeftLeg.render(matrixStack, consumerOneLeft, lightOne, OverlayTexture.NO_OVERLAY, colorLeftOne);
            ...
            this.model.RightLeg.render(matrixStack, consumerOneRight, lightThree, OverlayTexture.NO_OVERLAY, colorRightOne);
            ...
            if (renderTypeLeft.equals("double")) {
                ...
                this.model1.LeftLeg.render(matrixStack, consumerTwoLeft, lightTwo, OverlayTexture.NO_OVERLAY, colorLeftTwo);
            }
            ...
            if (renderTypeRight.equals("double")) {
                ...
                this.model1.RightLeg.render(matrixStack, consumerTwoRight, lightFour, OverlayTexture.NO_OVERLAY, colorRightTwo);
            }
        }
    }
