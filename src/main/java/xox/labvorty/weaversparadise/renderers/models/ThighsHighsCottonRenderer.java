...
public class ThighsHighsCottonRenderer implements ICurioRenderer {
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
        ...
        if (stack.getItem() instanceof ThighHighsCotton cottonThighHighs) {
            ...
            String renderTypeLeft = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "cotton").getRenderType();
            ResourceLocation tex1left = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "cotton").getTextureOne();
            ResourceLocation tex2left = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "cotton").getTextureTwo();

            String renderTypeRight = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeRight, "cotton").getRenderType();
            ResourceLocation tex1right = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeRight, "cotton").getTextureOne();
            ResourceLocation tex2right = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeRight, "cotton").getTextureTwo();
