...
public class UshankaModelRenderer {
    public static void renderModel(
        ...
        ItemTexture primaryTexture = TextureRegistry.find("ushanka", renderingData.sTL(), "pri");
        ...
        ItemTexture secondaryTexture = TextureRegistry.find("ushanka", renderingData.sTR(), "sec");
        ...
        VertexConsumer vc1 = renderingUtils.parseVC(multiBufferSource, renderingData.dTLO(), tex1left, "ushanka", renderingData.glint(), renderingData.glintColor());
        model.Head.render(
                poseStack,
                vc1,
                fCLO.getB(),
        ...
        if (renderTypeLeft) {
            VertexConsumer vc2 = renderingUtils.parseVC(multiBufferSource, renderingData.dTLT(), tex2left, "ushanka", renderingData.glint(), renderingData.glintColor());
            model.Head.render(
                    poseStack,
                    vc2,
                    fCLT.getB(),
        ...
        VertexConsumer vc3 = renderingUtils.parseVC(multiBufferSource, renderingData.dTRO(), tex1right, "ushanka", renderingData.glint(), renderingData.glintColor());
        model.Head.render(
                poseStack,
                vc3,
                fCRO.getB(),
        ...
        if (renderTypeRight) {
            VertexConsumer vc4 = renderingUtils.parseVC(multiBufferSource, renderingData.dTRT(), tex2right, "ushanka", renderingData.glint(), renderingData.glintColor());
            model.Head.render(
                    poseStack,
                    vc4,
                    fCRT.getB(),
