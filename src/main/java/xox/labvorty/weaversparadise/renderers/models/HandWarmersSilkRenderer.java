...
public class HandWarmersSilkRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("weaversparadise", "textures/clothing/hand_warmers_silk.png");
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
        ...
        if (stack.getItem() instanceof HandWarmersSilk handWarmersSilk) {
            ...
            String renderTypeLeft = WeaversParadiseHandWarmersTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "silk").getRenderType();
            ResourceLocation tex1left = WeaversParadiseHandWarmersTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "silk").getTextureOne();
            ResourceLocation tex2left = WeaversParadiseHandWarmersTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "silk").getTextureTwo();

            String renderTypeRight = WeaversParadiseHandWarmersTextureHandler.getByTypeAndMaterial(stensilTypeRight, "silk").getRenderType();
            ResourceLocation tex1right = WeaversParadiseHandWarmersTextureHandler.getByTypeAndMaterial(stensilTypeRight, "silk").getTextureOne();
            ResourceLocation tex2right = WeaversParadiseHandWarmersTextureHandler.getByTypeAndMaterial(stensilTypeRight, "silk").getTextureTwo();
