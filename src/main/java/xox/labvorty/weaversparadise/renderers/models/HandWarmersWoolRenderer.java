...
public class HandWarmersWoolRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("weaversparadise", "textures/clothing/hand_warmers_warm.png");
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
        ...
        if (stack.getItem() instanceof HandWarmersWool handWarmersWool) {
            ...
            String renderTypeLeft = WeaversParadiseHandWarmersTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "wool").getRenderType();
            ResourceLocation tex1left = WeaversParadiseHandWarmersTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "wool").getTextureOne();
            ResourceLocation tex2left = WeaversParadiseHandWarmersTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "wool").getTextureTwo();

            String renderTypeRight = WeaversParadiseHandWarmersTextureHandler.getByTypeAndMaterial(stensilTypeRight, "wool").getRenderType();
            ResourceLocation tex1right = WeaversParadiseHandWarmersTextureHandler.getByTypeAndMaterial(stensilTypeRight, "wool").getTextureOne();
            ResourceLocation tex2right = WeaversParadiseHandWarmersTextureHandler.getByTypeAndMaterial(stensilTypeRight, "wool").getTextureTwo();
