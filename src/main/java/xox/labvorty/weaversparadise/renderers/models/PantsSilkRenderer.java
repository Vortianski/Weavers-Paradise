...
import xox.labvorty.weaversparadise.items.PantsSilk;
...
public class PantsSilkRenderer implements ICurioRenderer {
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
        ...
        if (stack.getItem() instanceof PantsSilk pantsSilk && !entity.getItemBySlot(EquipmentSlot.LEGS).is(WeaversParadiseItems.ASTOLFO_ARMOR_LEGGINGS)) {
