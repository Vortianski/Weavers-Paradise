...
public class ThighsHighsSilkRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("weaversparadise", "textures/clothing/thigh_highs_silk.png");
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing,
        ...
        if (stack.getItem() instanceof ThighHighsSilk thighHighsSilk) {
            ...
            String renderTypeLeft = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "silk").getRenderType();
            ResourceLocation tex1left = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "silk").getTextureOne();
            ResourceLocation tex2left = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeLeft, "silk").getTextureTwo();

            String renderTypeRight = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeRight, "silk").getRenderType();
            ResourceLocation tex1right = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeRight, "silk").getTextureOne();
            ResourceLocation tex2right = WeaversParadiseThighHighsTextureHandler.getByTypeAndMaterial(stensilTypeRight, "silk").getTextureTwo();
