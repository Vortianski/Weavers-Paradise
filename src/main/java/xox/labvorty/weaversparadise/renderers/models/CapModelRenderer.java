...
public class CapModelRenderer {
    public static void renderModel(
        ...
        ItemTexture texture = TextureRegistry.find("cap", renderingData.sT(), renderingData.mat());
        ...
        VertexConsumer vc1 = renderingUtils.parseVC(multiBufferSource, renderingData.dTO(), tex1, "cap", renderingData.glint(), renderingData.glintColor());
        ...
        if (renderType) {
            VertexConsumer vc2 = renderingUtils.parseVC(multiBufferSource, renderingData.dTT(), tex2, "cap", renderingData.glint(), renderingData.glintColor());
            model.renderToBuffer(
                    poseStack,
                    vc2,
                    fCT.getB(),
