...
public class CottonSkirtModelRenderer {
    public static void renderModel(
            MultiBufferSource multiBufferSource,
            CottonSkirtModel<?> model,
        ...
        ItemTexture primaryTexture = TextureRegistry.find("skirt", renderingData.sTL(), "cotton_pri");
        ...
        ItemTexture secondaryTexture = TextureRegistry.find("skirt", renderingData.sTR(), "cotton_sec");
        ...
        VertexConsumer vc1 = renderingUtils.parseVC(multiBufferSource, renderingData.dTLO(), tex1left, "skirt", renderingData.glint(), renderingData.glintColor());
        model.Body.render(
                poseStack,
                vc1,
                fCLO.getB(),
        ...
        if (renderTypeLeft) {
            VertexConsumer vc2 = renderingUtils.parseVC(multiBufferSource, renderingData.dTLT(), tex2left, "skirt", renderingData.glint(), renderingData.glintColor());
            model.Body.render(
                    poseStack,
                    vc2,
                    fCLT.getB(),
        ...
        VertexConsumer vc3 = renderingUtils.parseVC(multiBufferSource, renderingData.dTRO(), tex1right, "skirt", renderingData.glint(), renderingData.glintColor());
        model.Body.render(
                poseStack,
                vc3,
                fCRO.getB(),
        ...
        if (renderTypeRight) {
            VertexConsumer vc4 = renderingUtils.parseVC(multiBufferSource, renderingData.dTRT(), tex2right, "skirt", renderingData.glint(), renderingData.glintColor());
            model.Body.render(
                    poseStack,
                    vc4,
                    fCRT.getB(),
