...
public class PomponHatModelRenderer {
    public static void renderModel(
            MultiBufferSource multiBufferSource,
            PomponHatModel<?> model,
        ...
        ItemTexture texture = TextureRegistry.find("pompon_hat", renderingData.sT(), renderingData.mat());
        ...
        VertexConsumer vc1 = renderingUtils.parseVC(multiBufferSource, renderingData.dTO(), tex1, "pompon_hat", renderingData.glint(), renderingData.glintColor());
        ...
        if (renderType) {
            VertexConsumer vc2 = renderingUtils.parseVC(multiBufferSource, renderingData.dTT(), tex2, "pompon_hat", renderingData.glint(), renderingData.glintColor());
            model.renderToBuffer(
                    poseStack,
                    vc2,
                    fCT.getB(),
