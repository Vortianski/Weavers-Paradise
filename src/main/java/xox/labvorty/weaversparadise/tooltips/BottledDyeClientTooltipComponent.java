...
@OnlyIn(Dist.CLIENT)
public class BottledDyeClientTooltipComponent implements ClientTooltipComponent {
    ...
    public BottledDyeClientTooltipComponent(ResourceLocation texture, String text, String type, int lightValue, int primaryColor, int secondaryColor) {
        this(texture, text, type, lightValue, 8, 8, primaryColor, secondaryColor);
    }

    public BottledDyeClientTooltipComponent(ResourceLocation texture, String text, String type, int lightValue, int width, int height, int primaryColor, int secondaryColor) {
    ...
    public int getWidth(Font font) {
        return (width + 2 + font.width(WeaversParadiseDyeTextHandler.getOrDefault(this.text).getText()));
    }
    ...
    public void renderImage(Font font, int x, int y, GuiGraphics guiGraphics) {
        ...
        guiGraphics.drawString(font, getComponentFromType(text, type, ticks, primaryColor, secondaryColor), x + (width + 2), y + 1, 0xFFFFFF);

        RenderSystem.disableBlend();
    }

    public MutableComponent getComponentFromType(String stext, String type, int ticks, int primaryColor, int secondaryColor) {
